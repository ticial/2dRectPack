 ...
 */
class Packer {
    constructor(containerWidth, containerHeight, direction = "none") {
...
const packingDirectionSelect = document.getElementById("packing-direction");
let blocksParams = [];
...
packingDirectionSelect.onchange = event => {
    changeDirection(packingDirectionSelect.value);
};
